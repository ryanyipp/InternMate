...
This project was rebuilt from a locally running prototype into a fully deployed web application. On the frontend, I used **React** and **Tailwind CSS** to redesign the UI with a strong focus on clarity, spacing, and consistency. I implemented light and dark themes, reusable stat components, and data visualisations using **Recharts** to show application breakdowns, trends, and streaks.
